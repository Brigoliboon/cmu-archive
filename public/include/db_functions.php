...
function addDocument($conn, $documentData, $filePath) {
    ...
    $categoryId = isset($documentData['categoryId']) ? (int)$documentData['categoryId'] : 'NULL';
    $userId = (int)$documentData['userId'];
    $fileLocation = sanitize($conn, $filePath);
    $accessLevel = (int)$documentData['accessLevel'];
    
    $sql = "INSERT INTO document (Title, FileType, FileTypeDescription, CategoryID, UserID, FileLocation, AccessLevel) 
            VALUES ('$title', '$fileType', '$fileTypeDescription', $categoryId, $userId, '$fileLocation', $accessLevel)";
...
// Function to unflag a document
function unflagDocument($conn, $documentId) {
    $documentId = (int)$documentId;
...
function deleteDocument($conn, $documentId) {
    $documentId = (int)$documentId;
